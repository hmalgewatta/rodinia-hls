...
void needwun(volatile char SEQA[ALEN], volatile char SEQB[BLEN],
		volatile char alignedA[ALEN+BLEN], volatile char alignedB[ALEN+BLEN],
...
//#pragma HLS INTERFACE m_axi port=SEQA offset=slave bundle=gmem0 depth=10000000
//#pragma HLS INTERFACE m_axi port=SEQB offset=slave bundle=gmem1 depth=10000000
...
#pragma HLS INTERFACE ap_bus port=SEQA
#pragma HLS INTERFACE ap_bus port=SEQB
#pragma HLS INTERFACE ap_bus port=alignedA
#pragma HLS INTERFACE ap_bus port=alignedB
